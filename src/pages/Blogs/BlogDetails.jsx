    ...
    <>
      ...
      <div className='border-2 rounded-2xl my-5 md:my-10 p-5 md:p-8 lg:p-10'>
        ...
        <div className="flex flex-wrap">
          <Link
            className="border-2 duration-200 ease inline-flex items-center mb-1 mr-1 transition py-3 px-5 rounded-full text-white border-blue-600 bg-blue-600 hover:bg-blue-700 hover:border-blue-700"
          >
            <svg
              aria-hidden="true"
              fill="currentColor"
